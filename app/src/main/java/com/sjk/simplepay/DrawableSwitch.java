...
public class DrawableSwitch extends View {
    ...
    private int textCloseColor; // 文字颜色
        ...
        for (int i = 0; i < n; i++) {
            ...
            // 获得自定义的属性值
            {
                ...
                case R.styleable.drawableSwitch_textColor:
                    ...
                    break;
                case R.styleable.drawableSwitch_textCloseColor:
                    textCloseColor = ta.getColor(attr, Color.WHITE); // 文字颜色，白色
                    break;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSwitchOn == true) { // 打开时的状态
            ...
            paint.setColor(Color.WHITE); // 文字颜色设置为布局文件里的值
